...
var sketch1 = function (p) {
  ...
  var y = 100;
  p.setup = function () {
    var canvas = p.createCanvas(p.windowWidth / 2 - 170, p.windowHeight + 200);
...
var sketch3 = function (p) {
  ...
  p.setup = function () {
    var canvas = p.createCanvas(p.windowWidth / 2 - 170, p.windowHeight + 200);
    canvas.parent("#sketch1");
    canvas.position(p.windowWidth / 2 + 200, 54);
  };
...
var sketch2 = function (p) {
  ...
  //------------------------------------------------SETUP-----------------------------------------------
  p.setup = function () {
    var canvas = p.createCanvas(320, 700);
    canvas.parent("#sketch2");
    canvas.position(p.windowWidth / 2 - 170, 250);
    p.pixelDensity(1);
  ...
  p.draw = function () {
    ...
    p.copy(video, 0, h / 2, w, 1, 0, x, w, 1);
